...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.accountService.userFullName.subscribe(userName => {
    ...
    this.accountService.userImage.subscribe(userImage => {
      ...
      debugger;
      this.UserImage = userImage.length>0 ? this.apiUrlImage + userImage : '';
    ...
    this.UserImage = this.UserImage.length>0 ? this.apiUrlImage + this.UserImage : '';
